    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.edit-user').forEach(button => {
            button.addEventListener('click', function(e) {
                ...
                // document.getElementById('edit-user-sub').value = sub;
                // document.getElementById('edit-user-privacy').value = privacy;
...
`;
                ...
                allPrivacyOptions.forEach(privacy_option => {
                    // console.log(gender); // This will log each gender during the loop
                    // console.log(privacy_option.sub_type);
                    var option = document.createElement('option');
