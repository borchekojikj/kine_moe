...
<div class="container-fluid px-4">
    ...
    <div class="row">
        ...
        <div class="col-10">
            <div class="row">
                <form action="{{ route('movies.update-movie', ['id'=> $movie->id]) }}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownEditors">
                                                ...
                                                <li>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="{{ $editor->id }}" id="editor{{ $editor->id }}" name="editor" {{ in_array($editor->id, $filteredWorkers['26']) ? 'checked' : '' }}>
