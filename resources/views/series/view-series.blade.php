...
<div class="container-fluid px-4">
    ...
    <div class="alert alert-info" role="alert">
        There are no series in the database.
    </div>
    @else
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-danger" href="{{ route('series.delete-series', ['id' => $movieID]) }}">Delete</a>
                        <a class="btn btn-warning" href="{{ route('series.edit-series', ['id' => $movieID]) }}">Edit</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
